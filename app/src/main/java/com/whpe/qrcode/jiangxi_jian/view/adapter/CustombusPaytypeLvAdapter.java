...
public class CustombusPaytypeLvAdapter extends BaseAdapter {
    private Context mycontext;
    //private String[] paytype_selects;
    //private int[] paytype_selects_img;
    private int int_paytype_select=0;
    private TypedArray typedArray;
    private ArrayList<PaytypeCustombusBean> paytypeCustombusBeans;

    public CustombusPaytypeLvAdapter(Context context, ArrayList<PaytypeCustombusBean> paytypeCustombusBeans) {
        mycontext=context;
        ...
        this.paytypeCustombusBeans=paytypeCustombusBeans;
    }
    ...
    public String getPaytypeCode(){
        return paytypeCustombusBeans.get(int_paytype_select).getPayWayCode();
    }

    @Override
    public int getCount() {
        return paytypeCustombusBeans.size();
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if(view==null){
            view=LayoutInflater.from(mycontext).inflate(R.layout.item_custom_paytype,viewGroup,false);
        }
        PaytypeCustombusBean paytypePrepayBean=paytypeCustombusBeans.get(i);
